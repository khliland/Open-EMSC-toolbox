 function [ZCorrectedF,ZResidualsF,ZParametersF]=emsc_rep_correction_cv(ZFTIRSel,EMSCModelFinal,SamplesNameStart,SamplesNameEnd,EMSCWeights,plotid)
%emsc_rep_correction_cv [ZCorrectedF,ZResidualsF,ZParametersF]=emsc_rep_correction_cv(ZFTIRSel,SamplesNameStart,SamplesNameEnd,EMSCOption,NComp,EMSCWeights,plotid)
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                                                                                      %
%  Achim Kohler                                          %
...
%                                                                                      %
%                                                                                      %
%  first version: 07.03.08                                                             %
%  revised version: 03.08.11                                                           %
%                                                                                      %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
