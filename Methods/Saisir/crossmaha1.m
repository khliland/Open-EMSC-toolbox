...
%crossmaha1 		- crossvalidation (random) of discriminant analysis applied after PCA 
%function[discrtype2]=crossmaha1(saisir,group,among,maxvar,ntest)
...
%applied after PCA with up to maxvar, among the first 'among' components
...
pcatype=pca(cal);
coordsup=applypca(pcatype,val);
cal=selectcol(pcatype.score,1:among);
val=selectcol(coordsup,1:among);
